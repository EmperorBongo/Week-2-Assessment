...
//CODE HERE
const pizza = {
    name: 'The BRONSONATOR',
    price: 12,
    catagory: 'Meat',
    popularity: 100,
    rating: 100,
    tags: ['Meat', 'Extra Cheese','New York Style']
}
...
const foodArr = [
    ...
    },
    {
        ...
        popularity: 88,
        rating: 90,
        tags: ['Vegetarian', 'Veggies', 'Healthy']
    }
]
const filteredFood = foodArr.filter(foodArr => foodArr.tags.includes('Meat'))
